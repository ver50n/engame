...
@section('content')
  ...
  <h4>@lang('common.user') @lang('common.view-page')</h4>
      ...
      <div class="card-body">
        <table class="table table-bordered table-striped table-hover table-condensed">
          <tbody>
            ...
            <tr>
              <th>@lang('common.short_description')</th>
            ...
            <tr>
              <th>@lang('common.profile')</th>
              <td>{{$obj->profile}}</td>
            </tr>
            <tr>
              <th>@lang('common.profile_image')</th>
              <td>{{$obj->profile_image}}</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="table table-bordered table-striped table-hover table-condensed">
          <tbody>
            <tr>
              ...
              <td>{{Lang::get('application-constant.YES_NO.'.App\Helpers\ApplicationConstant::YES_NO[$obj->is_active])}}</td>
            </tr>
          </tbody>
        </table>
      </div>
